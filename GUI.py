...
header = [[sg.Text('Movie Name', size=(55, 1)), sg.Text(
    'Rating', size=(8, 1)), sg.Text('Genres', size=(25, 1))]]
input_rows = [[sg.Text(names[i], size=(55, 1)), sg.Text(rating[i], size=(
    3, 2)), sg.Text(genres[i], size=(25, 1))] for i in range(len(names))]
